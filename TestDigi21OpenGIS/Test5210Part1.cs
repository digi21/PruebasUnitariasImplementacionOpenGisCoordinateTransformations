...
{
    [TestClass]
    public class Test5210Part1 : VerticalCoordinateSystemTestBase
    {
        [TestMethod]
        public void Test5210_part_1()
        {
        ...
        [TestMethod]
        public void Test5210_part_1_Wkt()
        {
        ...
        [TestMethod]
        public void Test5210_part_1_Epsg()
        {
        ...
        public void Test5210_part_1_Epsg_Inverse()
        {
            var vertA = CoordinateSystemAuthorityFactory.CreateVerticalCoordinateSystem(5611);
            var vertB = CoordinateSystemAuthorityFactory.CreateVerticalCoordinateSystem(5706);

            ExecuteTests(vertB, vertA, true);
        }

        [TestMethod]
        public void Test5210_part_1_WktEpsg()
        {
        ...
        [TestMethod]
        public void Test5210_part_1_MathTransform()
        {
            MathTransformFactory mtf = new MathTransformFactory();

            IMathTransform d = mtf.CreateFromWkt(@"CONCAT_MT[PARAM_MT[""Affine"", PARAMETER[""num_row"",2], PARAMETER[""num_col"", 2],PARAMETER[""elt_0_0"", -1],PARAMETER[""elt_0_1"", 0],PARAMETER[""elt_1_0"", 0],PARAMETER[""elt_1_1"", -1]]]");
