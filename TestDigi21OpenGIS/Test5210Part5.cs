...
{
    [TestClass]
    public class Test5210Part5 : VerticalCoordinateSystemTestBase
    {
        [TestMethod]
        public void Test5210_part_5_Epsg()
        {
            var vertA = CoordinateSystemAuthorityFactory.CreateVerticalCoordinateSystem(5706);
        ...
        [TestMethod]
        public void Test5210_part_5_WktEpsg()
        {
            IVerticalCoordinateSystem vertA = (IVerticalCoordinateSystem)factory.CreateFromWkt(@"VERT_CS[""Caspian depth"",VERT_DATUM[""Caspian Sea"",2005,AUTHORITY[""EPSG"",""5106""]],UNIT[""metre"",1,AUTHORITY[""EPSG"",""9001""]],AXIS[""D"", Down],AUTHORITY[""EPSG"",""5706""]]");
        ...
        [TestMethod]
        public void Test5210_part_5_MathTransform()
        {
            MathTransformFactory mtf = new MathTransformFactory();

            IMathTransform t = mtf.CreateFromWkt(@"CONCAT_MT[INVERSE_MT[PARAM_MT[""vertical_offset"",PARAMETER[""vertical_offset"",-28]]],PARAM_MT[""Affine"", PARAMETER[""num_row"",2], PARAMETER[""num_col"", 2],PARAMETER[""elt_0_0"", -1],PARAMETER[""elt_0_1"", -0],PARAMETER[""elt_1_0"", -0],PARAMETER[""elt_1_1"", -1]]]");
